...
document.addEventListener("DOMContentLoaded", function() {
  if (document.querySelectorAll(".contacts-page").length > 0) {
    time = 800;
    $(
      ".main-callback,.main-feedback,.main-offices-list,.main-offices-text,.main-offices-title"
    ).appear();
    $(
      ".main-callback,.main-feedback,.main-offices-list,.main-offices-text,.main-offices-title"
    ...
    time = 400;
    $("section p,section h4,section a,section img,.internal-banner").appear();
    $("section p,section h4,section a,section img,.internal-banner").on(
      "appear",
    ...
    time = 700;
    $(".filter,.blog-slider,.blog-cards__container").appear();
    $(".filter,.blog-slider,.blog-cards__container").on("appear", function(
      event,
      $all_appeared_elements
    ) {
      $($all_appeared_elements).fadeTo(time, 1, function() {});
    });
    $(".filter,.blog-slider,.blog-cards__container").on("disappear", function(
      event,
      $all_disappeared_elements
    ) {
      $($all_disappeared_elements).fadeTo(time, 0, function() {});
    });
  } else {
